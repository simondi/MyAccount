angular.module('portal.pages.checkout')
    .controller('AdminFeeCheckoutController', function ($state, $scope, $stateParams, lodash, Order, ngToast, $uibModal, PreviousState) {
        'use strict';
        ...
        if (!$stateParams.adminFeePaymentInfo || !$stateParams.order) {
            $state.go('licenses');
        }
        ...
        ctrl.adminFeePaymentInfo =
        {
            AdminFeeDetails: $stateParams.adminFeePaymentInfo,
        ...
        ctrl.confirmAndPay = function() {
            ...
            ctrl.adminFeePaymentInfo.paymentInfo = ctrl.paymentInfo;
        ...
        function excutePaymentService(a, b) {
            Order.processAdminFee({ id: a }, ctrl.adminFeePaymentInfo).$promise
                .then(function () {
                    ngToast.create(b);
